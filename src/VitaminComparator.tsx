...
import { FlaskConical, Check, Info, Zap, Shield, AlertTriangle, BookOpen, ChevronDown, ChevronUp } from 'lucide-react';
...
const VitaminComparator = () => {
  ...
  const b12Active = (s: string) => s.includes("메코") || s.includes("히드록소") || s.includes("코바마미드");
  ...
  return (
    <div className="min-h-screen bg-[#0f0f14] text-white font-sans pb-16 max-w-lg mx-auto">
      ...
      {/* Selectors — sticky */}
      <div className="sticky top-0 z-30 bg-[#0f0f14]/95 backdrop-blur-sm px-3 py-2 border-b border-white/5">
